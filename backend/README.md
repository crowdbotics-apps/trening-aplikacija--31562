...
## Project Structure
    ...
    ├── trening_aplikacija__31562  # Django project configurations
...
1. Clone this repo and `cd trening_aplikacija__31562`
...
2. Clone this repo and `cd trening_aplikacija__31562`
